<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
					...
					<li><a href="manage-rooms.php"><i class="fa fa-desktop"></i> Rooms</a>
					
				</li>
				</li>
					<li><a href="manage-rooms.php"><i class="fa fa-desktop"></i> Landlord</a>
					<ul>
						<li><a href="add_managers.php">Add Landlord</a></li>
						<li><a href="manage-managers.php">Manage Landlord</a></li>
					</ul>
				</li>
