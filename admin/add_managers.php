...
$query="insert into landlord(name, username, hostel, email, phone, password) 
values('$name','$username','$hostel','$email','$phone','$password')";
$stmt = mysqli_query($mysqli,$query);
if ($stmt==TRUE) {
    # code...
    echo"<script>alert('Landlord has been added successfully');</script>";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add Landlord</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add Landlord</div>
	...
	<input type="text" class="form-control" name="username" id="cns" value="" required="required">
									...
									<input type="password" class="form-control" name="password" value="" >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Add Landlord">
												</div>
											</div>
